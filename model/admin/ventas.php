...
<head>
    ...
    <script src="busqueda_venta.js"></script>
...
<body class="body2">
      ...
      <div class="flex-grow-1 p-3">
        <h1>Módulo de Administración - Ventas</h1>
      
      <section>
        <div class="d-flex">
        <div class="mr-5 d-block mt-5">
                <label class="ml-3 search" for="caja-busqueda">Buscar: </label>
                <input class="input-search" style="width: 300px; border-radius: 5px; border: solid 1px;" type="text" name="caja-busqueda" id="caja-busqueda" placeholder="Documento del Vendedor o ID de Venta">
        </div>
        <div class="mt-5 ms-5">
        <a href="" onclick="window.open('nueva_venta.php','','width= 700,height=500, toolbar=NO'); 
                        void(null);"><button class="btn btn-danger">Nueva Venta</button></a>
        </div>
        </div>
